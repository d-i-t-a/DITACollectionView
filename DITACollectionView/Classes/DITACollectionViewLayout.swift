//
//  DITACollectionViewLayout.swift
//
...
@objc public protocol DITACollectionViewDelegate: UICollectionViewDelegate {
...
public enum DITACollectionViewLayoutItemRenderDirection: Int {
    case renderDirectionShortestFirst
...
public class DITACollectionViewLayout: UICollectionViewLayout {
    ...
    public var itemRenderDirection: DITACollectionViewLayoutItemRenderDirection {
        didSet {
            invalidateLayout()
        }
    }
    ...
    public weak var delegate: DITACollectionViewDelegate? {
        get {
            return self.collectionView!.delegate as? DITACollectionViewDelegate
        }
    }
    ...
    override public init() {
        ...
        self.itemRenderDirection =
            DITACollectionViewLayoutItemRenderDirection.renderDirectionShortestFirst
